export const [Map, Zoom, Home, Locate, LayerList] = await $arcgis.import([
  "@arcgis/core/Map.js",
...
viewElement.addEventListener("arcgisViewReadyChange", async () => {
  ...
  navigationLogo.thumbnail = portalItem.thumbnailUrl;
   ...
   const activityLayer = viewElement.map.layers.find((layer) => layer.title === "Reported ICE Activity");
...
//     });
    ...
    // web form implentation resource https://community.esri.com/t5/arcgis-survey123-blog/introducing-the-survey123-web-app-javascript-api/ba-p/896667
            webform = new Survey123WebForm({
    clientId: "TqNytD7KVv0aydHP",
    container: "formDiv",
    itemId: "609a24d9406645969f2a348135d05951"
});
});